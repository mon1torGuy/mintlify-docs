---
title: "Routing"
description: "Master TypeAuth's request routing system. Configure URL transformations, handle path variables, and manage traffic flow to your origin servers."
---
